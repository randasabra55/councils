...
class AddTopicScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<GetAllMeetingCubit,GetAllMeetingStates>(
      listener: (context,state){},
      builder: (context,state){
        GetCouncilModel? getCouncilModel=GetAllMeetingCubit.get(context).getCouncilModel;
        meetingInfo? model=GetAllMeetingCubit.get(context).getCouncilModel?.values as meetingInfo?;
       // GetCouncilModel m=GetAllMeetingCubit.get(context).getCouncilModel.values as GetCouncilModel;
        return Scaffold(
          body: Column(
            children: [
              SizedBox(
