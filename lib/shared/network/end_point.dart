const Activate='api/User/ActivateEmail';
const LOGIN = 'api/User/Login';
const FORGETPASSWORD='api/User/ForgetPassword';
const CONFIRMOTP='api/User/ConfirmOTP';
const ADDNEWPASS='api/User/AddNewPassword';
